...
from src.model.model import (
    ...
    # ST-Norm (Deng et al., KDD 2021) — SNorm+TNorm plugged into a Wavenet-
    # style TCN. Retrain-only (per-node TNorm running stats). See model.py.
    STNORM_Model,
    # STAEformer (Liu et al., CIKM 2023) — spatio-temporal adaptive embedding
    # + alternating temporal/spatial self-attention. Retrain-only (adaptive
    # embedding sized to args.graph_size).
    STAEFORMER_Model,
)
...
if __name__ == "__main__":
    ...
    vars(args)["methods"] = {
        ...
        # ST-Norm (Deng et al., KDD 2021).
        'STNORM': STNORM_Model,
        # STAEformer (Liu et al., CIKM 2023).
